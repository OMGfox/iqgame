...
class Figure:
    ...
    def rotate(self):
        ...
        height = len(temp_scheme)
        new_scheme = [[0] * height for i in range(width)]
...
class PurpleFigure(Figure):
    def __init__(self, name):
        super().__init__(name)
        self.block_3 = Block("img/purple_3.png")
        self.block_2 = Block("img/purple_2.png")
        self.block_1 = Block("img/purple_1.png")
...
class Button:
    def __init__(self, main_sprite):
        self.mouseover_sprite = None
        self.screen = None
        self.main_sprite = None
        self.no_clicked_sprite = None
        self.clicked_sprite = None
        self.blocked_sprite = None
        self.state = "no_clicked"
        self.pos = (0, 0)
    ...
    def is_mouseover(self):
        ...
        if ((mouse_pos[0] >= self.pos[0] and mouse_pos[1] >= self.pos[1]) and
                (mouse_pos[0] <= self.pos[0] + self.width and mouse_pos[1] <= self.pos[1] + self.height)):
            return True
        return False
    ...
    def draw(self):
        x = self.pos[0]
        y = self.pos[1]
        self.screen.blit(self.no_clicked_sprite, (x, y))
    ...
    def init_sprites(self):
        self.no_clicked_sprite = self.main_sprite
